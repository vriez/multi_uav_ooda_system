...
\caption{D6/D7 Delivery Mission: Point-to-point delivery routes showing loaded (blue) UAV-2 approaching the drop-off position. UAV 3 proceeding to the pick-up position, outside of the coverage area, upon given permission. UAV 4 reached the boundary of the covered zone, which triggers operator permission request. Dashboard displays real-time operator alert interface.}
