...
Table~\ref{tab:scenario_comparison} summarizes performance across all experimental scenarios, demonstrating consistent sub-millisecond response times and perfect safety record.
