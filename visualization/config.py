...
TELEMETRY_INTERVAL = 1.0   # Client update rate (1 Hz) - reduced to prevent payload overflow
...
DELIVERY_ARRIVAL_THRESHOLD = 2.0    # Distance to consider package pickup/delivery complete (m)
...
UAV_STATE_AWAITING_PERMISSION = 'awaiting_permission'  # Delivery safety - waiting at grid boundary
